	...
	return (
		...
		>
			...
			<div className="flex flex-col sm:flex-row gap-8 px-8">
				<div className="flex flex-col justify-between gap-2 p-8 max-w-sm bg-gray-900 hover:bg-yellow-200 rounded-2xl outline-offset-4 hover:outline hover:outline-offset-4 hover:outline-yellow-200 duration-75 group">
