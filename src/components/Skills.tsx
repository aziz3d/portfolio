...
export default function Skills() {
	return (
		<section id="section" className="px-8">
			<div className="relative flex flex-col gap-8 p-8 w-full bg-gradient-to-tr from-yellow-400 via-yellow-300 to-yellow-200 rounded-2xl shadow-inner">
				...
				<div className="flex justify-center items-center flex-wrap gap-4 z-10">
					<div className="flex justify-center items-center gap-2 px-6 py-3 h-14 bg-yellow-400 hover:bg-yellow-200 hover:outline hover:outline-offset-4 hover:outline-yellow-200 rounded-full duration-200">
