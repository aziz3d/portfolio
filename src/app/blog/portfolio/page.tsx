	...
	return (
		<>
			<main className="bg-white pb-16 pt-8 antialiased lg:pb-24 lg:pt-16">
				<div className="mx-auto flex max-w-screen-xl justify-between px-4 text-neutral-700">
					<article className="format format-sm sm:format-base lg:format-lg format-blue dark:format-invert mx-auto w-full max-w-2xl">
						...
						<p className="lead">
							...
							built with the utility-first classes from Tailwind
							CSS. It also includes interactive elements such as
							dropdowns, modals, datepickers.
						</p>
						<p>
						...
						<p>
							You&apos;ll also receive a lot of useful application
							UI, marketing UI, and e-commerce pages that can help
							you get started with your projects even faster. You
							can check out this{" "}
						...
						<ol>
							<li>
								...
								running a usability test, you&apos;ll be able to
								see how users will interact with your design
								once it&apos;s live;
							</li>
							<li>
						...
						<pre>
							<code className="language-html">
								<dl className="grid max-w-screen-md grid-cols-2 gap-8 text-gray-900 sm:grid-cols-3">
						...
						<p>
							...
							the real deal. If you&apos;re simply preparing a
							quick visual aid for a presentation, a low-fidelity
						...
						<p>
							...
							user&apos;s needs and habits early on will save you
						...
						<p>
							...
							prototypes ‘inside out&apos;. Start by focusing on
							what will be important to your user, like a Buy now
							button or an image gallery, and list each element by
							order of priority. This way, you&apos;ll be able to
							create a prototype that puts your users&apos; needs
